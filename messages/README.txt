...
The Question:
	...
	- No, using a local machine does not show the content and gives me 
	  ...
	  Informatik/comp20/comp20-jshin/messages/data.json. Cross origin 
...
What has been correctly implemented and what has not:
	...
	Using JavaScript's XMLHttpRequest object to load JSON data, parse the 
	JSON file, and output the data to a section of a completely loaded HTML
	file is implemented.
